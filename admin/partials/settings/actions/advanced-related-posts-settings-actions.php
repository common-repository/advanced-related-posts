<?php
    require_once( ADVANCED_RELATED_POSTS_ADMIN_PATH . "/partials/settings/actions/advanced-related-posts-settings-actions-options.php" );
?>
        ...
        <form method="post" id="<?php echo $class_prefix; ?>form">
            ...
            <?php
                for($tab_ind = 1; $tab_ind <= 4; $tab_ind++){
                    require_once( ADVANCED_RELATED_POSTS_ADMIN_PATH . "/partials/settings/actions/partials/advanced-related-posts-settings-actions-tab".$tab_ind.".php" );
                }
            ?>
