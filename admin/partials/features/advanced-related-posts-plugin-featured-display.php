...
<div class="wrap">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo ADVANCED_RELATED_POSTS_ADMIN_URL . "/images/icons/icon-quiz-128x128.png"; ?>" alt="Quiz Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo ADVANCED_RELATED_POSTS_ADMIN_URL; ?>/images/icons/icon-survey-128x128.png" alt="Survey Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo ADVANCED_RELATED_POSTS_ADMIN_URL; ?>/images/icons/icon-poll-128x128.png" alt="Poll Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo ADVANCED_RELATED_POSTS_ADMIN_URL; ?>/images/icons/icon-sccp-128x128.png" alt="Secure Copy Content Protection">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo ADVANCED_RELATED_POSTS_ADMIN_URL; ?>/images/icons/icon-gallery-128x128.png" alt="Gallery - Photo Gallery">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo ADVANCED_RELATED_POSTS_ADMIN_URL; ?>/images/icons/icon-popup-128x128.png" alt="Popup Box">
                    <div class="card-body">
                        <h5 class="card-title">Popup Box</h5>
                        <p class="card-text">The Popup Box WordPress plugin allows you to create fully customizable, responsive and engaging popups. Either you want to build your own by starting from scratch or use one of our beautiful ready-made themes, it is so easy with us.</p>
