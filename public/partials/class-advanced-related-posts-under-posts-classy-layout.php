...
class Advanced_Related_Posts_Under_Posts_CLASSY_Layout extends Advanced_Related_Posts_Public{
    ...
    public function get_leyout_styles(){
        ...
        $content[] = '
            ...
            #' . $this->html_class_prefix . 'under-posts-container-' . $this->unique_id_in_class . '.' . $this->html_class_prefix . $this->layout_name . '-layout .' . $this->html_class_prefix . 'under-post-date-author-row {
                border-bottom: 0.5px solid ' . Advanced_Related_Posts_Data::hex2rgba( $this->options[ $this->name_prefix . 'under_posts_text_color' ] , 0.4 ) . ';
            }
