...
class Advanced_Related_Posts_Widget_CLASSY_Layout extends Advanced_Related_Posts_Widget{
    ...
    public function layout_create_post( $post ){
        ...
        $content[] = '<div class="' . $this->html_class_prefix . 'widget">';
            ...
            $content[] = '<div class="' . $this->html_class_prefix . 'widget-header">';
                ...
                $content[] = '<div class="' . $this->html_class_prefix . 'widget-count-row">';
                    $content[] = '<span class="' . $this->html_class_prefix . 'widget-count-text">';
                    $content[] = $post_count;
                    $content[] = '</span>';
                $content[] = '</div>';
            ...
            $content[] = '<div class="' . $this->html_class_prefix . 'widget-content">';                
                ...
                $content[] = '<div class="' . $this->html_class_prefix . 'widget-title-row">';
                    $content[] = '<span class="' . $this->html_class_prefix . 'widget-title">';
            ...
            $content[] = '</div>';
            $content[] = '<div class="' . $this->html_class_prefix . 'widget-arrow">';
                $content[] = '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 600.148 494.148" style="enable-background:new 0 0 494.148 494.148;" xml:space="preserve">
                    <g>
                        <g>
    ...
    public function get_leyout_styles(){
        ...
        $content[] = '
            ...
            #' . $this->html_class_prefix . 'widget-container-' . $this->unique_id_in_class . '.' . $this->html_class_prefix . $this->layout_name . '-layout .' . $this->html_class_prefix . 'widget-date-author-row {
                border-bottom: 0.5px solid ' . Advanced_Related_Posts_Data::hex2rgba( $this->options[ $this->name_prefix . 'widget_text_color' ] , 0.4 ) . ';
            }
